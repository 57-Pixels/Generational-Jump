# National Defense Strategy — Generational Jump

> **Status:** framework — strategy for a country modernizing from an 80s–90s force after a distant-war wake-up call.
> This is **not** an asymmetric "never buy prestige platforms" strategy. The mandate is a **full-domain generational jump**. Budget and factories pace the jump; they do not cancel domains.
...
1. **Threat vs. mirror:** do we size against Korvath specifically, or against a generic modern peer derived from wake-up-war lessons?
2. **Sequence risk:** which domain, if left legacy too long, makes the rest of the modern force useless? (Starter answer: C4ISR and air defense early; capital ships late is acceptable.)
3. **Active vs. reserve mix** once modern kit arrives.
4. **Sacred cows:** what we refuse to underfund (ammo surge? AD? submarines?).

## Starter strategic concept: "Replace the Force"
